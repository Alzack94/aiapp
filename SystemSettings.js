...
export default class SystemSettings extends Component {
    ...
    constructor(props) {
      super(props);
      this._restoreBrightness = this._restoreBrightness.bind(this);
      this.state = {
        volume: 0,
    ...
    _changeVolType = async () => {
      this.volIndex = (this.volIndex + 1) % this.volTypes.length;
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.row}>
              ...
              <TouchableOpacity onPress={this._restoreBrightness}>
